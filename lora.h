...
// Сообщение отправляемое модулем LoRa, для получения сведений о версии
#define CHECK_VERSION_MESSAGE {0xC3, 0xC3, 0xC3}

// Сообщение отправляемое модулем LoRa, для получения последних сохранённых параметров конфигурации
#define SAVED_PARAMS_MESSAGE {0xC1, 0xC1, 0xC1}

// Сообщение отправляемое модулем LoRa, для сброса конфигурации к дефолтному значению
#define RESET_CONFIG_MESSAGE {0xC4, 0xC4, 0xC4}
...
/*----------------------------------------------------------------------
 Инициализация радиомодуля с настройками по умолчанию
----------------------------------------------------------------------*/
uint8_t lora_init();
...
/*----------------------------------------------------------------------
 Задание режима отправки данных: FIXED_TRANSM; TRANSPARENT_TRANSM;
----------------------------------------------------------------------*/
